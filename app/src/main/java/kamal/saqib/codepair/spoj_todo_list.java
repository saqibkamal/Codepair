...
public class spoj_todo_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spoj_todo_list);

        listView=(ListView) findViewById(R.id.listview);

        shared=this.getSharedPreferences("kamal.saqib.codepair", Context.MODE_PRIVATE);
        final Set<String> s= shared.getStringSet("spoj",null);
        final ArrayList<String> array=new ArrayList<String>();
        if(s!=null) {
            array.addAll(s);
            final ArrayAdapter adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, array);
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                    new android.support.v7.app.AlertDialog.Builder(spoj_todo_list.this).
                            setTitle("Remove").
